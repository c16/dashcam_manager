...
/// Mobile-optimized video grid with directory selector
class MobileVideoGrid extends StatelessWidget {
  const MobileVideoGrid({super.key});
                ...
                children: [
                  ...
                  Expanded(
                    child: DropdownButton<String>(
                      isExpanded: true,
                      value: appState.currentDirectory,
            ...
            builder: (context, appState, child) {
              ...
              return GridView.builder(
                ...
                gridDelegate: const SliverGridDelegateWithMaxCrossAxisExtent(
                  ...
                  childAspectRatio: 0.75, // 3:4 ratio for thumbnails
                  crossAxisSpacing: 12,
                  mainAxisSpacing: 12,
                ),
      ...
      child: InkWell(
        onTap: () {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('Added ${video.filename} to queue'),
